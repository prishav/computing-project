...
<span style="color:#0000FF;font-family:Arial;font-size:32px;"><strong>BOOK DETAILS</strong></span></div>
			...
			<tr  style="height: 30px;vertical-align: bottom;padding: 15px;text-align: left;">
				...
				<td><a onclick="return confirm('Do you want to cancel booking?')" href="<?php echo base_url();?>book/deleteBooking?id=<?php echo $row->book_id; ?>">
				<button type="submit" name="cancel" class="btn btn-primary">cancel booking</button></a></td>
