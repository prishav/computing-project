...
<form name="form1" action="<?php echo base_url();?>customerdetails/getData/" method="post">
	<fieldset>
...
<form name="form1" action="<?php echo base_url();?>customerdetails/searchUser/" method="post">
			Username:<input type="text" size="15" name="username" title="unamebox"   /><br /><br />
